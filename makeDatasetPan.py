        ...
        for frequency in [400]:
            for width in ['0.001', '0.002', '0.005', '0.010', '0.020', '0.050', '0.100', '0.200', '0.500']:
                for depth in [1, 2, 3, 4, 5, 6, 7, 8, 9]:
                    if frequency == 25:
                        fpath = 'data_pancake/ID' + str(coil) + '/L' + str(lift) + 'mm/F0' + str(frequency) + '/sig_z_d' + str(coil) + '_l' + str(lift) + '_f0' + str(frequency) + '_w' + width + '_d' + str(depth) + '_s*'
                    else:
                        fpath = 'data_pancake/ID' + str(coil) + '/L' + str(lift) + 'mm/F' + str(frequency) + '/sig_z_d' + str(coil) + '_l' + str(lift) + '_f' + str(frequency) + '_w' + width + '_d' + str(depth) + '_s*'
